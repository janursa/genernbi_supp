...
#SBATCH --output=/home/jnourisa/projs/ongoing/genernbi_supp/src/MMP/logs/granie_multiome_%j.out
#SBATCH --error=/home/jnourisa/projs/ongoing/genernbi_supp/src/MMP/logs/granie_multiome_%j.err
#SBATCH --ntasks=1
