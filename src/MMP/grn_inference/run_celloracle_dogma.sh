...
#SBATCH --output=/home/jnourisa/projs/ongoing/genernbi_supp/src/MMP/logs/celloracle_dogma_%j.out
#SBATCH --error=/home/jnourisa/projs/ongoing/genernbi_supp/src/MMP/logs/celloracle_dogma_%j.err
#SBATCH --ntasks=1
