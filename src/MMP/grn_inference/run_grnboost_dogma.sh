...
#SBATCH --output=/home/jnourisa/projs/ongoing/geneRNBI/src/MMP/logs/grnboost_dogma_%j.out
#SBATCH --error=/home/jnourisa/projs/ongoing/geneRNBI/src/MMP/logs/grnboost_dogma_%j.err
#SBATCH --ntasks=1
