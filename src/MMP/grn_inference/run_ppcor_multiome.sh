...
#SBATCH --output=/home/jnourisa/projs/ongoing/geneRNBI/src/MMP/logs/ppcor_multiome_%j.out
#SBATCH --error=/home/jnourisa/projs/ongoing/geneRNBI/src/MMP/logs/ppcor_multiome_%j.err
#SBATCH --ntasks=1
